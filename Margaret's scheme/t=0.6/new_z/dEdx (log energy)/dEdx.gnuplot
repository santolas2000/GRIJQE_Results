...
set title "-dE/dx (M, log scheme for ε, fixed z_0) (Q_1 = Q_2 = 2 GeV, g = 1, m = 0.2 GeV)"
...
plot[0.:0.6][0.:] "1_sqrt2/MV_dEdx.txt" using 1:2 with lines title "MV vp = 1/√2" lc rgb "red", \
	"1.0/MV_dEdx.txt" using 1:2 with lines title "MV vp = 1.0" lc rgb "black", \
