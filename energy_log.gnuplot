...
plot [0.:0.1] [0.:] 15.9773 - 29.6759 * (2 / GeV_fm * x)**2 + 42.6822 * (2 / GeV_fm * x)**4 - 49.2686 * (2 / GeV_fm * x)**6 title "τ^6" lc rgb "dark-chartreuse" lw 2, \
            "Log Scheme/Qs = 2/dEdx/1.0/MV_Energy.txt" using 1:2 with lines title "Q = 2GeV, m=0.2 GeV" lc rgb "dark-magenta" dt 2 lw 2, \
