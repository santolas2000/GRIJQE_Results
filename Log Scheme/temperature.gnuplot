...
plot [0.:0.6][0.4:0.8] "Qs = 2.6/dEdx/1.0/MV_Temperature.txt" using 1:2 with lines title "MV m=0.2GeV Nf=2" lc rgb "red", \
	'' using 1:3 with lines title "MV m=0.2GeV Nf=3" lc rgb "dark-red", \
    "Qs = 2.6, m = 0.26/dEdx/1.0/MV_Temperature.txt" using 1:2 with lines title "MV m=0.26GeV Nf=2" lc rgb "red" dt 2, \
	'' using 1:3 with lines title "MV m=0.26GeV Nf=3" lc rgb "dark-red" dt 2, \
